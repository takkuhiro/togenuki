...
>
> **エンドツーエンド動作確認**:
> - [ ] ログイン → Gmail連携 → 連絡先登録 の一連のフローが動作することを確認
> - [ ] 上司・取引先のメールアドレスを連絡先として登録する
> - [ ] 学習処理が完了し、「学習完了」ステータスになることを確認
> - [ ] 登録した連絡先からメールを送信し、ダッシュボードに表示されることを確認
> - [ ] 連絡先を削除し、関連データ（contact_context）も削除されることを確認
>
> **デモシナリオリハーサル**:
> - [ ] 連絡先管理画面への導線を確認
> - [ ] 連絡先登録 → 学習完了 → メール受信・変換・再生 の一連のフローをリハーサル
