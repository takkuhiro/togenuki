...
>
> **動作確認**:
> - [ ] 連絡先登録フォームに入力して送信できることを確認
> - [ ] 無効なメールアドレス形式でバリデーションエラーが表示されることを確認
> - [ ] 連絡先一覧に登録した連絡先が表示されることを確認
> - [ ] 学習中の連絡先に「学習中」ラベルが表示されることを確認
> - [ ] 学習完了後に「学習完了」ステータスに変わることを確認（30秒ポーリング）
> - [ ] 削除ボタンクリックで確認ダイアログが表示されることを確認
> - [ ] 削除確認後に連絡先が一覧から消えることを確認
>
> **デプロイ**:
