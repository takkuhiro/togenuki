...
- [ ] 8. VoiceReplyPanelコンポーネントを実装する
- [ ] 8.1 音声入力と認識テキスト編集フェーズを実装する
...
- [ ] 8.4 VoiceReplyPanelのユニットテストを作成する
...
- [ ] 9. EmailCardに音声入力ボタンを統合する
- [ ] 9.1 EmailCardのアクションエリアに音声入力ボタンとVoiceReplyPanelを統合する
