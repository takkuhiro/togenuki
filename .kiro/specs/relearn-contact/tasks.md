...
- [x] 2. フロントエンド: 再学習API関数の追加
- [x] 2.1 (P) 再学習用のAPI呼び出し関数を追加する
...
- [x] 3. フロントエンド: ContactCardへの再学習ボタン追加
- [x] 3.1 再学習ボタンをContactCardに追加する
...
- [x] 4. フロントエンド: ContactListへの再学習フロー統合
- [x] 4.1 再学習の確認ダイアログとAPI呼び出しフローを実装する
